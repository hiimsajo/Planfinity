package Planfinity.mainproject.ledgergroup.controller;
...
import Planfinity.mainproject.ledgergroup.dto.LedgerGroupResponseDto;
import Planfinity.mainproject.ledgergroup.invitationDto.InvitationMemberResponseDto;
import Planfinity.mainproject.ledgergroup.invitationDto.InvitationPostDto;
import Planfinity.mainproject.ledgergroup.invitationDto.InvitationResponseDto;
...
public class LedgerGroupController {
    ...
    public ResponseEntity<List<LedgerGroupResponseDto>> getLedgerGroups() {
        List<LedgerGroup> ledgerGroups = this.ledgerGroupService.getLedgerGroups();
    ...
    @Valid @RequestBody InvitationPostDto invitationPostDto) {
        LedgerGroup ledgerGroup = ledgerGroupService.invite(ledgerGroupId, invitationPostDto);
        return new ResponseEntity<>(new InvitationResponseDto(ledgerGroup), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity inviteMember(@PathVariable("ledger-group-id") @Positive Long ledgerGroupId) {
        ...
        return new ResponseEntity<>(new InvitationMemberResponseDto(ledgerGroup), HttpStatus.OK);
    }
